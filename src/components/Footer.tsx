...
const SOCIAL_MEDIA = [
  ...
  },
  {
    name: "X",
    icon: X,
    url: "https://x.com/kailashkalamkari",
    label: "Follow us on X",
  },
  {
    name: "YouTube",
    icon: Youtube,
    url: "https://youtube.com/@kailashkalamkarisarees?si=oUOAYh3q6yVTxUCM",
  ...
  return (
    <footer className="bg-[#f0ece3] text-[#645C5A] relative overflow-hidden pb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="mb-4">
              <p className="text-xs font-semibold text-[#d49217] mb-3 uppercase tracking-wide">
                Follow Us
              </p>
              <SocialMediaLinks />
            </div>
          ...
          {/* Quick Location */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-[#d49217]">
              Location
            </h4>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex space-x-6 text-sm">
              <a
                ...
                className="hover:text-[#d49217] transition-colors cursor-pointer"
              >
                Privacy Policy
              </a>
              <a
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(125% 125% at 50% 10%, #d49217 0%, #f0ece3 100%)",
        }}
      />
    </footer>
  )
