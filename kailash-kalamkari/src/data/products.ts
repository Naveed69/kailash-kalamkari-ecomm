...
export const sampleProducts: Product[] = [
  ...
  {
    id: '5',
    name: 'Bridal Kalamkari Lehenga Set',
    price: 12000,
    originalPrice: 15000,
    image: kalamkariHero,
    category: 'Lehengas',
    description: 'Exquisite bridal lehenga with intricate kalamkari work and gold borders',
    colors: ['#dc2626', '#ca8a04', '#1e3a8a'],
    inStock: false,
  },
  {
    id: '6',
    name: 'Kalamkari Block Print Kurta',
    price: 1800,
    image: kalamkariProducts,
    category: 'Kurtas',
    description: 'Comfortable cotton kurta featuring traditional kalamkari block prints',
    colors: ['#1e3a8a', '#7c2d12', '#065f46'],
    inStock: true,
  },
  {
    id: '7',
  ...
  {
    id: '8',
    name: 'Lotus Pond Kalamkari Stole',
    price: 950,
    image: kalamkariProducts,
    category: 'Stoles',
    description: 'Silk stole featuring beautiful lotus pond design with natural dyes',
    colors: ['#065f46', '#dc2626', '#ca8a04'],
    inStock: true,
  },
];
